...
const trustItems = [
  {
    ...
    desc: 'Recevez vos commandes rapidement partout au Mali et en Afrique de l\'Ouest.',
  ...
  },
  {
    ...
    desc: 'Tous nos produits sont vérifiés et garantis 100% authentiques.',
  ...
  },
  {
    ...
    desc: 'Notre équipe répond rapidement sur WhatsApp pour vous aider.',
    ...
    <div className="min-h-screen">
      ...
      <div className="bg-primary text-white text-center py-2.5 px-4">
        <p className="text-sm font-medium">
          🎉 Livraison offerte sur toute commande &gt; 50 000 FCFA — Utilisez WhatsApp pour commander sans inscription
        </p>
      </div>
      ...
      <section className="container mx-auto px-4 py-16 md:py-20">
        ...
        >
          ...
          <h2 className="font-['Poppins'] text-3xl md:text-4xl font-bold text-[#303841] mb-3">
            Nos Catégories
          </h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Parcourez nos différentes catégories de produits pour trouver ce qui vous convient
          </p>
        </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div>
              ...
              <h2 className="font-['Poppins'] text-3xl md:text-4xl font-bold text-[#303841]">
                Produits Vedettes
              </h2>
            ...
            <Button
              asChild
              variant="outline"
              className="rounded-xl border-2 border-primary text-primary hover:bg-primary hover:text-white self-start md:self-auto"
            >
      ...
      <section className="container mx-auto px-4 py-16 md:py-20">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            3 étapes simples pour recevoir votre commande à domicile
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {orderSteps.map(({ step, icon: Icon, title, desc, color }, i) => (
            <motion.div
              key={step}
            ...
            >
              <div className="flex flex-col items-center">
                <div className={`relative mb-5 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br ${color} shadow-lg`}>
                  ...
                  <span className="absolute -top-2 -right-2 flex h-6 w-6 items-center justify-center rounded-full bg-[#303841] text-white text-xs font-bold">
                    {i + 1}
                  </span>
                </div>
      ...
      <section className="bg-[#303841] py-16 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {trustItems.map(({ icon: Icon, title, desc, color, border }, i) => (
              <motion.div
                key={title}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className={`bg-white/5 border border-white/10 ${border} rounded-xl p-6 h-full transition-all duration-300 hover:bg-white/10`}>
      ...
      <section className="container mx-auto px-4 py-16 md:py-20">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#25D366] via-[#20BA5A] to-[#128C7E] p-8 md:p-12 text-center"
        >
          {/* Decorative blobs */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-lg mb-8 max-w-lg mx-auto">
              Notre équipe répond rapidement sur WhatsApp. Commandez, posez vos questions, nous sommes là pour vous.
            </p>
            <Button
              asChild
              size="lg"
              className="rounded-xl bg-white text-[#128C7E] hover:bg-white/90 font-bold px-8 py-6 text-base shadow-xl"
            >
              <a
