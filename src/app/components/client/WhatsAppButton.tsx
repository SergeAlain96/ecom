    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="bg-[#303841] text-white text-xs font-medium px-3 py-1.5 rounded-lg shadow-lg whitespace-nowrap pointer-events-none"
          >
      ...
      <div className="relative">
        ...
        <motion.a
          ...
          className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/40 hover:shadow-xl hover:shadow-[#25D366]/50 transition-shadow"
